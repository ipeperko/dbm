...
BOOST_AUTO_TEST_CASE(item_narrow_cast_test)
{
    ...
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set(1.1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set(1.1));
    ...
    BOOST_REQUIRE_NO_THROW(dbm::local<short>()->set((long long)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<short>()->set((unsigned short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<short>()->set((unsigned int)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<short>()->set((unsigned long long)1));
    ...
    BOOST_REQUIRE_NO_THROW(dbm::local<int>()->set((long long)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<int>()->set((unsigned short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<int>()->set((unsigned int)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<int>()->set((unsigned long long)1));

    // int container - set value of a different integer type
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set(true));
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set((short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set((int)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set((unsigned short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set((unsigned int)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<long long>()->set((unsigned long long)1));
    ...
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned short>()->set((long long)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned short>()->set((unsigned int)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned short>()->set((unsigned long long)1));
    ...
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned int>()->set((long long)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned int>()->set((unsigned short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned int>()->set((unsigned long long)1));

    // int container - set value of a different integer type
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set(true));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set((short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set((int)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set((long long)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set((unsigned short)1));
    BOOST_REQUIRE_NO_THROW(dbm::local<unsigned long long>()->set((unsigned int)1));
}
